  ...
  describe('#create()', () => {
    ...
    it('should generate scaffolding for "aws-clojure-gradle" template', () => {
      ...
      return create.create().then(() => {
        ...
        expect(dirContent).to.include(path.join('src', 'main', 'resources',
          'log4j.properties'));
        expect(dirContent).to.include(path.join('src', 'main', 'clojure',
          'hello.clj'));
    ...
    it('should generate scaffolding for "aws-clojurescript-gradle" template', () => {
      ...
      return create.create().then(() => {
        ...
        expect(dirContent).to.include(path.join('gradle', 'wrapper',
          'gradle-wrapper.properties'));
        expect(dirContent).to.include(path.join('src', 'main', 'clojurescript',
          'serverless', 'functions.cljs'));
    ...
    it('should generate scaffolding for "aws-ruby" template', () => {
      ...
      return create.create().then(() => {
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, 'serverless.yml')))
          .to.be.equal(true);
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, 'handler.rb')))
          .to.be.equal(true);
    ...
    it('should generate scaffolding for "aws-cpp" template', () => {
      process.chdir(tmpDir);
      create.options.template = 'aws-cpp';

      return create.create().then(() => {
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, 'serverless.yml')))
          .to.be.equal(true);
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, 'handler.cpp')))
          .to.be.equal(true);
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, 'Makefile')))
          .to.be.equal(true);
        expect(create.serverless.utils.fileExistsSync(path.join(tmpDir, '.gitignore')))
          .to.be.equal(true);
